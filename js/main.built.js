...
},{"./Brain.jsx":31,"react":26}],29:[function(require,module,exports){
'use strict';
...
var ColorPicker = function (_React$Component) {
    ...
    function ColorPicker(props) {
        ...
        _this.boundSetR = _this.setR.bind(_this);
        _this.boundSetG = _this.setG.bind(_this);
        _this.boundSetB = _this.setB.bind(_this);
...
var Brain = function (_React$Component) {
    ...
    function Brain(props) {
        ...
        _this.state = { colors: [], r: 255, g: 255, b: 255, color: 'rgb(255,255,255)', mouseDown: false };
        ...
        _this.boundHandleTouchStart = _this.handleTouchStart.bind(_this);
    ...
    _createClass(Brain, [{
        ...
        value: function handleTouchMove(e) {
            ...
            for (var i = 0; i < lt; i++) {
                ...
                var x = touch.clientX;
                var y = touch.clientY;
                var myColors = this.replaceColor(this.touchToId(x, y));
                this.setState({ colors: myColors });
            }
        }
    }, {
        ...
        value: function touchToId(x, oldY) {
            ...
            var id = (row - 1) * this.dimension + (col - 1);
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'div',
                    { className: 'brain', 'data-pugnat': true, onTouchStart: this.boundHandleTouchStart, onTouchMove: this.boundHandleTouchMove },
                    boxes
                ),
                _react2.default.createElement(
                    'div',
